<template>
    <main>
            ...
            <p>
                &emsp;This is the West Lake. A single picture can't show all its beauty.
            </p>
            <figure class="in-text">
                <img src="image/west_lake.jpg" alt="west lake">
            </figure>
            <p>
                ...
                Because of my childhood. One of my dreams is to become a game designer or game programmer, and I'm currently working on it.
            ...
            <video id="intro-video" width="320" height="240" controls>
        ...
        <footer>
            ...
            <ul class="extra-links">
                <li><a href="mailto:ttlovemiku@gmail.com">Email me</a></li>
                <li><a href="https://www.linkedin.com/in/yangye1995/" target="_blank">Linked In</a></li>
                <li><a href="https://live.bilibili.com/24438" target="_blank">My live streaming site on bilibili.com</a></li>
            </ul>
        </footer>
</template>
